/**
 * Main entrypoint for NeoCLI Agent SDK types.
 *
...
/**
 * A scheduled task from `<dir>/.NeoCLI/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.NeoCLI/scheduled_tasks.json` and yield events as tasks fire.
 *
