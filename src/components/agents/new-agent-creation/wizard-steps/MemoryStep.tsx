...
export function MemoryStep() {
  ...
  if ($[1] !== isUserScope) {
    t1 = isUserScope ? [{
      label: "User scope (~/.NeoCLI/agent-memory/) (Recommended)",
      value: "user"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "Project scope (.NeoCLI/agent-memory/)",
      value: "project"
    }, {
      label: "Local scope (.NeoCLI/agent-memory-local/)",
      value: "local"
    }] : [{
      label: "Project scope (.NeoCLI/agent-memory/) (Recommended)",
      value: "project"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "User scope (~/.NeoCLI/agent-memory/)",
      value: "user"
    }, {
      label: "Local scope (.NeoCLI/agent-memory-local/)",
      value: "local"
