...
- Do not include information that's already in the NeoCLI.md files included in the context
 ...
 * Custom prompts can be placed at ~/.NeoCLI/session-memory/prompt.md
