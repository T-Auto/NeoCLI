 ...
 * Initialized during NeoCLI startup.
 */
 ...
 * asynchronously during NeoCLI startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during NeoCLI startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/NeoCLI/issues/15521:
 ...
 *
 * This should be called during NeoCLI shutdown. Stops all running LSP servers
