 ...
 * .NeoCLI/settings.json) are still blocked even if their parent is in allowOnly.
 */
...
export function isPathAllowed(
  ...
  // This MUST come before checkPathSafetyForAutoEdit since .NeoCLI is a dangerous directory
