  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.NeoCLI/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .NeoCLI/settings.json'
      } else {
        userGuidance =
      ...
      // from .NeoCLI/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
