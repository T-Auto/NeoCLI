export const BASE_CHROME_PROMPT = `# NeoCLI in Chrome browser automation
...
/**
 * Minimal hint about NeoCLI in Chrome skill availability. This is injected at startup when the extension is installed
