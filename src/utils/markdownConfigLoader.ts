...
export function getProjectDirsUpToHome(
  ...
  while (true) {
    ...
    const claudeSubdir = join(current, '.NeoCLI', subdir)
 ...
 * @param dir Directory (eg. "~/.NeoCLI/commands")
 * @returns Array of parsed markdown files with metadata
 */
