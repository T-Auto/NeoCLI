...
export const DESCRIPTION = 'Get or set NeoCLI configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set NeoCLI configuration settings.

  View or change NeoCLI settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.NeoCLI/.config.json)
${globalSettings.join('\n')}
