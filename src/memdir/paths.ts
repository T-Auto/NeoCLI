 ...
 *
 * SECURITY: projectSettings (.NeoCLI/settings.json committed to the repo) is
 ...
 * same repo share one auto-memory directory (anthropics/NeoCLI#24382).
 */
