...
# NeoCLI installer
# Usage: curl -fsSL https://raw.githubusercontent.com/T-Auto/NeoCLI/main/install.sh | bash
...
REPO="https://github.com/T-Auto/NeoCLI.git"
INSTALL_DIR="$HOME/NeoCLI"
...
build_binary() {
  info "Building NeoCLI (all experimental features enabled)..."
  cd "$INSTALL_DIR"
...
link_binary() {
  ...
  ln -sf "$INSTALL_DIR/cli-dev" "$link_dir/NeoCLI"
  ok "Symlinked: $link_dir/NeoCLI"
