...
const iconBuild = Bun.spawnSync({ cmd: ['bun', 'run', './scripts/generate-installer-icon.ts'], cwd: root, stdout: 'inherit', stderr: 'inherit' })
if (iconBuild.exitCode !== 0) process.exit(iconBuild.exitCode ?? 1)
